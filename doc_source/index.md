...
+ [Working with Pipelines in CodePipeline](pipelines.md)
   ...
   + [View Execution History in CodePipeline](pipelines-view-history.md)
...
+ [Monitoring Pipelines with CodePipeline](monitoring.md)
   ...
   + [View Current Source Revision Details in a Pipeline in CodePipeline](monitoring-source-revisions-view.md)
