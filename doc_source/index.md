...
+ [Working with pipelines in CodePipeline](pipelines.md)
   ...
   + [Clone a pipeline in CodePipeline](pipelines-clone.md)
...
+ [Monitoring pipelines](monitoring.md)
...
+ [Update a GitHub version 1 source action to a GitHub version 2 source action](update-github-action-connections.md)
+ [Quotas in AWS CodePipeline](limits.md)
+ [Appendix A: GitHub version 1 source actions](appendix-github-oauth.md)
