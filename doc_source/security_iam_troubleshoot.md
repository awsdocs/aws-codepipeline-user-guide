# Troubleshooting AWS CodePipeline identity and access<a name="security_iam_troubleshoot"></a>
...
## I am not authorized to perform an action in CodePipeline<a name="security_iam_troubleshoot-no-permissions"></a>
...
## I'm an administrator and want to allow others to access CodePipeline<a name="security_iam_troubleshoot-admin-delegate"></a>
...
## I want to allow people outside of my AWS account to access my CodePipeline resources<a name="security_iam_troubleshoot-cross-account-access"></a>
